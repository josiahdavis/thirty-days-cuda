/*
 * Comparison of Naive Matrix Multiplication with CUBLAS.
 * Compile: nvcc 16_matmul_cublas.cu -o main -lcublas
 * Run: ./main
 */
...
int main() {
    ...
    if (verifyResults(h_C_custom, h_C_ref, M * N)) {
        printf("✅ PASS\n");
    } else {
        printf("❌ FAIL\n");
    }
